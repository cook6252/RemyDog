...
df = pd.DataFrame(
    dict(name=['matt', 'lisa', 'richard', 'john', 'Julia', 'jane', 'marlon'], age=[23, 78, 22, 19, 45, 33, 20],
         gender=['M', 'F', 'M', 'M', 'M', 'F', 'M'], state=['DC', 'CO', 'DE', 'VA', 'MD', 'DE', 'NY'],
         years_of_service=[10, 0, 2, 0, 2, 1, 5], iq=[300, 100, 110, 200, 300, 10, 40]))
########################################################
